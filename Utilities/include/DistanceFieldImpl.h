/*=====================================================================================*/
/*! \file		DistanceFieldImpl.h
	\author		skourasm
	\brief		Implementation of class DistanceFieldImpl
 */
/*=====================================================================================*/

#ifndef DistanceFieldImpl_h
#define DistanceFieldImpl_h
...
template<int d>
class DistanceFieldImpl
{
public: 
  DistanceFieldImpl(int iDim) {m_dim = iDim;}
  ~DistanceFieldImpl() {};

  std::vector<cfgScalar> computeDistances(const std::vector<cfgScalar> &iPoints, std::vector<cfgScalar> *ioDerivatives)
  {
