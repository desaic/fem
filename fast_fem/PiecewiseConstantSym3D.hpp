#ifndef PIECEWISE_CONSTANT_SYM_3D_HPP
#define PIECEWISE_CONSTANT_SYM_3D_HPP

#include "RealField.hpp"

///@brief the grid is column major.
///Symmetric version of PiecewiseConstant2D
class PiecewiseConstantSym3D : public RealField{
public:
  PiecewiseConstantSym3D() :gridSize(3, 0){}
